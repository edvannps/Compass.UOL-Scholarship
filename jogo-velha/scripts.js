...
// função que limpa a tela e declara um vencedor
...
function declareWinner(winner) {
    ...
    if (winner == 'x') {
        scoreBoardX.innerHTML = parseInt(scoreBoardX.textContent) + 1;
        msg = 'O jogador 1 venceu!';
    } else if (winner == 'o') {
        scoreBoardO.innerHTML = parseInt(scoreBoardO.textContent) + 1;
        msg = 'O jogador 1 venceu!';
    } else {
        msg = 'Deu Velha!';
    }
